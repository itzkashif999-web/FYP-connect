...
class MeetingsPage extends StatelessWidget {
  ...
  const MeetingsPage({super.key, required this.supervisorId});
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            // Outgoing Requests (sent by student)
            _buildMeetingsList(
            ...
            // Incoming Requests (sent by supervisor)
            _buildMeetingsList(
              query: FirebaseFirestore.instance
                  .collection("meetings")
                  .where("studentId", isEqualTo: currentUser?.uid)
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    // Show buttons only for incoming pending requests
