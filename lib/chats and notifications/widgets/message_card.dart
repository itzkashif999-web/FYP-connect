...
// import 'package:fyp_connect/chats/controller/auth_controller.dart';
...
//     return authController.user!.uid == message.fromId
//         ? _greenMesage()
//         : _blueMessage();
//   }
...
//           child: Container(
//             padding:
//                 EdgeInsets.all(message.type == Type.image ? 1.w : 3.w),
...
//                     child: isLocalImage(message.msg)
//                         ? Image.file(
...
//                           )
//                         : CachedNetworkImage(
//                             imageUrl: message.msg, // ✅ Network Image
//                             width: 50.w,
//                             height: 30.h,
...
//                 context: Get.context!, time: message.sent),
